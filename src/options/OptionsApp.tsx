  ...
  return (
    <div className="min-h-screen bg-zinc-50 p-8 text-zinc-950 dark:bg-zinc-950 dark:text-zinc-50">
      <div className="mx-auto max-w-lg space-y-6">
        <div>
          <h1 className="text-2xl font-semibold tracking-tight">FairFrame settings</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <p className="text-xs text-zinc-500 dark:text-zinc-500">
              If this URL is <strong>not</strong> the default demo host, FairFrame uses <strong>only</strong> your
